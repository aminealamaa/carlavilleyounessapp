...
interface Vehicle {
  ...
  userId?: string | null;
  kilometrage?: number;
  nextVidange?: number; // Kilometers for next oil change
}
              ...
              <div className="vehicle-info">
                ...
                <div className="vehicle-specs">
                  ...
                  <div className="vehicle-spec">
                    ...
                    <span>
                      {vehicle.nextVidange
                        ? `${vehicle.nextVidange} ${t("fleet.km")}`
                        : t("fleet.NA")}
                    </span>
                  </div>
                </div>
                <div className="vehicle-footer">
                  <div className="vehicle-rate">
                    <span className="rate-value">{vehicle.rate} MAD</span>
