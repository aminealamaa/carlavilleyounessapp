...
export const Clients = () => {
  ...
  const [sortField, setSortField] = useState<keyof Client>("fullName");
  ...
  // Handle refresh clients
  const handleRefreshClients = async () => {
    setIsRefreshing(true);
    try {
      await refetchClients();
      toast.success("Clients actualisés avec succès");
    } catch (error) {
  ...
  return (
    <div className="clients-page">
      <div className="clients-header">
        <h1>{t("clients.clientsManagement")}</h1>
              ...
              <div className="client-stats">
                ...
                <div className="client-stat-item">
                  <span className="stat-label">{t("clients.totalSpent")}</span>
                                      <span className="stat-value">{client.spent || 0} MAD</span>
                </div>
              </div>
