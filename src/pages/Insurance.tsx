...
export const Insurance = () => {
  ...
  const handleRefreshDocuments = async () => {
    ...
    try {
      ...
      toast.success("Documents d'assurance actualisés avec succès");
    } catch (error) {
      toast.error("Erreur lors de l'actualisation des documents");
    } finally {
    ...
    <div className="insurance-page">
      ...
      <div className="financial-summary">
        <div className="summary-card">
          ...
          <p className="amount">
                            {financialMetrics.totalRepairCost.toFixed(2)} MAD
          </p>
        </div>
        <div className="summary-card">
          <h3>{t("insurance.totalPayments")}</h3>
          <p className="amount">
                            {financialMetrics.totalPaymentAmount.toFixed(2)} MAD
          </p>
        </div>
        <div className="summary-card">
          <h3>{t("insurance.totalBalanceDue")}</h3>
          <p className="amount">
                            {financialMetrics.totalBalanceDue.toFixed(2)} MAD
          </p>
        </div>
      </div>
              ...
              <tbody>
                {filteredDocuments.map((doc) => (
                  <tr key={doc.id}>
                    ...
                    <td>
                      {doc.repair_cost ? doc.repair_cost.toFixed(2) : "0.00"} MAD
                    </td>
                    <td>
                      {doc.payment_amount
                    ...
                    <td>
                      {doc.balance_due ? doc.balance_due.toFixed(2) : "0.00"} MAD
                    </td>
                    <td>
