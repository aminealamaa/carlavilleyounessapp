...
export const Bookings = () => {
  ...
  const { data: bookings = [], isLoading, refetch: refetchBookings } = useQuery<Booking[]>({
    queryKey: ["bookings"],
    queryFn: async () => {
      const { data, error } = await supabase
        .from("bookings")
  ...
  const handleRefreshBookings = async () => {
    ...
    try {
      ...
      toast.success("Réservations actualisées avec succès");
    } catch (error) {
  ...
  // Add this handler in the Bookings component
                    ...
                    <td>
                      <div className="table-actions">
                        ...
                        <button
                          ...
                          style={{ background: '#dc2626', color: 'white', marginLeft: 8 }}
